...
export function ComboboxDemo() {
    return (
        <div className='flex w-full flex-col items-start gap-4 md:flex-row'>
            ...
            <TimezoneCombobox timezones={[...timezones]} selectedTimezone={timezones[0].timezones[0]} />
        </div>
    );
}
...
function TimezoneCombobox({
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button variant='outline' className='h-12 w-full justify-between px-2.5 md:max-w-[200px]'>
                    {selectedTimezone ? (
